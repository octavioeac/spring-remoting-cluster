...
public class HttpInvokerHandlerTest {
  ...
  void startup() throws Exception{
    ...
    server.start();
    proxy = new ProxyFactory(DummyInterface.class, new Interceptor(){}).getProxy();
  }
  ...
  public void testSimpleCall() throws Exception {
    ...
    //Capture the protocol definition from the protocol handler
  ...
  private Capture<ProtocolDefinition> recordProtocolDefinition(final Setup setup, final String serviceUrl)
